        ...
        <body>
          <div class="wrapper">
            <div class="card">
              ...
              <div class="grid">
                <div class="field">
                  <label for="api_key">API_KEY (Gemini)</label>
                  <input type="text" id="api_key" value="${keys.API_KEY || ''}" placeholder="Ingresa tu API Key de Gemini">
          ...
          <script>
            function guardarKeys() {
              ...
              google.script.run
                ...
                .guardarKeys({ API_KEY: apiKey, URL_PROYECTO: urlProyecto });
            }
          </script>
        </body>
      </html>
